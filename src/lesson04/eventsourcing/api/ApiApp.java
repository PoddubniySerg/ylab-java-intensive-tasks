...
public class ApiApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        personApi.deletePerson(0L);
        print(personApi.findPerson(0L).toString(), messenger, mapper);
        print(personApi.findPerson(3L).toString(), messenger, mapper);
        print(personApi.findAll().toString(), messenger, mapper);
    }
